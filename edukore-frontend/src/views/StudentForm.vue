      ...
      <form @submit.prevent="submitForm" class="space-y-8">
        ...
        <div class="bg-white border-slate-300 border dark:bg-slate-800 dark:border-slate-700 rounded-2xl p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Correo Institucional</label>
              <input v-model="form.student.email" required type="email" class="w-full bg-white/5 border border-slate-200 dark:border-slate-800 rounded-lg px-4 py-2 text-slate-900 dark:text-white focus:border-slate-500 focus:ring-1 focus:ring-slate-500 dark:focus:border-slate-500 dark:focus:ring-slate-500 focus:outline-none">
            </div>
            <div>
              <label class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Código de Matrícula</label>
              <input v-model="form.student.enrollment_number" required type="text" class="w-full bg-white/5 border border-slate-200 dark:border-slate-800 rounded-lg px-4 py-2 text-slate-900 dark:text-white focus:border-slate-500 focus:ring-1 focus:ring-slate-500 dark:focus:border-slate-500 dark:focus:ring-slate-500 focus:outline-none">
            </div>
            <div>
            ...
            <div v-for="(parent, index) in form.parents" :key="index" class="p-4 bg-white/5 rounded-xl border border-slate-200 dark:border-slate-800 relative">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input v-model="parent.email" required type="email" class="w-full bg-white/5 border border-slate-200 dark:border-slate-800 rounded-lg px-4 py-2 text-slate-900 dark:text-white focus:border-slate-500 focus:ring-1 focus:ring-slate-500 dark:focus:border-slate-500 dark:focus:ring-slate-500 focus:outline-none">
                </div>
                <div>
                  <label class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Teléfono</label>
                  <input v-model="parent.phone" required type="text" class="w-full bg-white/5 border border-slate-200 dark:border-slate-800 rounded-lg px-4 py-2 text-slate-900 dark:text-white focus:border-slate-500 focus:ring-1 focus:ring-slate-500 dark:focus:border-slate-500 dark:focus:ring-slate-500 focus:outline-none">
                </div>
              </div>
            </div>
          </div>
