...
// Use Str::uuid() for IDs if roles don't exist
$teacherRole = Role::where('name', 'Teacher')->first() ?: Role::create(['id' => Str::uuid(), 'name' => 'Teacher']);
$studentRole = Role::where('name', 'Student')->first() ?: Role::create(['id' => Str::uuid(), 'name' => 'Student']);
$parentRole = Role::where('name', 'Parent')->first() ?: Role::create(['id' => Str::uuid(), 'name' => 'Parent']);
...
\Illuminate\Support\Facades\DB::table('family_members')->updateOrInsert(
    ...
    ['id' => Str::uuid(), 'relation_type' => 'Padre', 'can_view_info' => true, 'is_primary_contact' => true, 'created_at' => now(), 'updated_at' => now()]
);

\Illuminate\Support\Facades\DB::table('family_students')->updateOrInsert(
    ['family_id' => $family->id, 'student_id' => $student->id],
    ['id' => Str::uuid(), 'relation_description' => 'Hijo', 'created_at' => now(), 'updated_at' => now()]
);
